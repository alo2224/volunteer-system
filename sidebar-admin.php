<div id='sidebar' class="nav nav-pills nav-stacked">
  <li role="presentation"><a href="<?php echo get_site_url(null , 'wolontariusz');?>">Wolontariusze</a></li>
  ...
  <li role="presentation"><a href="<?php echo get_site_url(null , 'wp-admin');?>">Panel Administracyjny</a></li>
</div>